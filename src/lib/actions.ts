...
// Unified Get Attendance Records Function
export const getAttendanceRecords = async (studentId = null, courseId = null, teacherId = null) => {
  try {
    const query = {
      where: {},
      include: {
   ...
   console.log(studentId);
    ...
    const attendanceRecords = await prisma.attendanceRecord.findMany(query);
